...
public class NotesResource {
	...
	public NotesDAO notesDAO;
		...
		public Response addNotes(@PathParam("notes") NotesVO notes,@PathParam("userId") int userId)
				throws AppException {
		...
		@Path("id/{userId}")
		@Produces(MediaType.APPLICATION_JSON)
		public Response getNotes(@PathParam("cls") Class cls,
				@PathParam("userId") int userId) throws AppException {
